...
<img src="https://www.dentago.co.uk/api/track/open?e=${encodeURIComponent(email)}&b=6" width="1" height="1" style="display:none" />
`.trim();
...
// ── Main ──────────────────────────────────────────────────────────────────────
async function main() {
  const csvPath = "/Users/mercier/Downloads/dataset_lead-scraper-apollo-zoominfo-lusha_2026-04-25_08-11-37-449.csv";
