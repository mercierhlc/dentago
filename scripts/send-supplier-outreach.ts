...
const suppliers = [
  {
    name: "Henry Schein UK",
    contactName: "Victoria",
    contact: "victoria.goodall@henryschein.co.uk",
    role: "VP & Managing Director, UK & Ireland",
  },
  {
    name: "Kent Express",
    contactName: "Anthony",
    contact: "anthony.trombetta@kentexpress.co.uk",
    role: "",
  },
  {
    name: "DD Group (Dental Directory)",
    contactName: "Jon",
    contact: "jon.wiltshire@ddgroup.com",
    role: "Chief Commercial Officer",
  },
  {
    name: "Trycare",
    contactName: "Craig",
    contact: "craig@trycare.co.uk",
    role: "General Manager",
  },
  {
    name: "Medisave",
    contactName: "Graham",
    contact: "gwright@medisave.co.uk",
    role: "Managing Director",
  },
  {
    name: "DHB Oral Healthcare",
    contactName: "Jo",
    contact: "jo.mcfadden@dhb.co.uk",
    role: "Managing Director",
  },
];

async function main() {
  console.log(`Sending supplier partnership emails to ${suppliers.length} contacts...\n`);
