# [WEEK 2 — Days 8 to 14: Build Core Product] Focus on growth: 20 outreach messages/day, 10 demos/week, keep improving the product based on what clinics ask for. Build the supplier analytics dashboard so you have real GMV data per supplier.
...
Task: Focus on growth: 20 outreach messages/day, 10 demos/week, keep improving the product based on what clinics ask for. Build the supplier analytics dashboard so you have real GMV data per supplier.
...
- Write a summary to `.agent-runs/summary-1777902331947.md`
