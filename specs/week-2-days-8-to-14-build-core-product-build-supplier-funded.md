# [WEEK 2 — Days 8 to 14: Build Core Product] Build supplier-funded promotions: suppliers can pay to run a promotion (e.g., 10% off composites this week) that appears as a banner on relevant search results
...
Task: Build supplier-funded promotions: suppliers can pay to run a promotion (e.g., 10% off composites this week) that appears as a banner on relevant search results
...
- Write a summary to `.agent-runs/summary-1777902335320.md`
