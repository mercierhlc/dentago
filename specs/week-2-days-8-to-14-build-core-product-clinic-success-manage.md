# [WEEK 2 — Days 8 to 14: Build Core Product] Clinic Success Manager is now handling all new clinic onboardings — spend 1 week training them on the exact onboarding script, common questions, and how to escalate issues
...
Task: Clinic Success Manager is now handling all new clinic onboardings — spend 1 week training them on the exact onboarding script, common questions, and how to escalate issues
...
- Write a summary to `.agent-runs/summary-1777902334937.md`
