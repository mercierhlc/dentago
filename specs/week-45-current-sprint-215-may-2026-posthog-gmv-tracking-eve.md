# [Week 4–5 — Current Sprint (2–15 May 2026)] PostHog GMV tracking event: implement `order_placed` event with properties supplier_id, gmv, clinic_id
...
Task: PostHog GMV tracking event: implement `order_placed` event with properties supplier_id, gmv, clinic_id
...
- Write a summary to `.agent-runs/summary-1777902336980.md`
